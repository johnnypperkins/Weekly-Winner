            ...
            VStack {
                ...
                ScrollView {
                    ...
                    VStack (spacing: 5) {
                        ...
                        Text("Challenges are a new and innovative way to compete directly against friends. You take one side of a wager and your friend takes the other.")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding(.bottom)
                        
                        Text("1. To start, select a game.")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding(.bottom)
                        ...
                        Text("2. Choose your opponent. You do this by searching up his username.")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding()
                        ...
                        Text("3. Choose your wager amount.")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding()
                        ...
                        Text("4. You and your opponent's corresponding Risk/Rewards will automatically adjust.")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding()
                        ...
                        Text("5. Submit the game and wait for completion. The winner will receive their PoolBucks!")
                            .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                            .foregroundColor(K.finalColor.textWhite)
                            .padding()
        ...
        VStack {
            ScrollView {
                ...
                VStack (spacing: 5) {
                    ...
                    Text("PoolBucks are WagerPool's in game currency! They are redeemable 1:1 for USD and can be thought of as such. You can attain PoolBucks by:")
                        .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                        .foregroundColor(K.finalColor.textWhite)
                        .padding(.bottom)
                    Text("1. Placing in the Daily Challenge.")
                        .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                        .foregroundColor(K.finalColor.textWhite)
                        .padding(.bottom)
                        .padding(.horizontal)
                    ...
                    Text("4. Purchasing them directly from the deposit page.")
                        .font(.custom(K.customFonts.lexendDecaMedium, size: 15))
                        .foregroundColor(K.finalColor.textWhite)
                        .padding(.bottom)
                        .padding(.horizontal)
