...
//                                    viewModel.createGroup(groupImageURL: selectedImage, groupAdminUsername: UserData.shared.username, groupName: groupName, groupSlogan: groupSlogan, password: password, ticketFormat: customizeTicketFormat(oneLegNum,twoLegNum,threeLegNum,fourLegNum,fiveLegNum))
                                    dismiss()
                                }
                            }
                        } label: {
