...
class bookViewModel: ObservableObject {
    ...
    func uploadBet(groupNumber: Int, betNumber: Int, team: String, betLine: Double, betOdds: Double, betType: BetType) {
        ...
        let bet = Bet(groupNumber: groupNumber, betNumber: betNumber, weekNumber: 1, betStatus: .open, betType: betType, teamBetOn: team, betLine: Float(betLine), betOdds: Float(betOdds), result: .notStarted)
